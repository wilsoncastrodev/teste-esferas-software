...
import { addCustomerValidation } from "../../validations/customerValidation";
import { createCustomer } from "../../stores/features/customerSlice";
import { getAddressByCEP } from 'cep-address-finder';
import { InputMask } from 'primereact/inputmask';
import { MDCSnackbar } from "@material/snackbar";

const CreateFormCustomer: FC = () => {
    ...
    return (
        <Formik
            ...
            onSubmit={async (payload, { resetForm }) => {
                ...
                snackbar.labelText = "Cliente cadastrado com sucesso";
